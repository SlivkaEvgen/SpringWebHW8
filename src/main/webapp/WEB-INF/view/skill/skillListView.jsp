...
<div class="w3-container w3-center w3-round">
    ...
    <a href="${pageContext.request.contextPath}/skill/" class="w3-btn w3-hover-light-blue w3-round-xlarge w3-center">Add New Skill</a>
    ...
    <table class="w3-padding 16 w3-hoverable w3-table-all w3-card-4 w3-small w3-margin-top w3-round w3-centered w3-animate-opacity"
        ...
        <c:forEach items="${list}" var="skill">
            <tr>
                ...
                <td>${skill.level}</td>
                <td>
                    <a href="${pageContext.request.contextPath}/skill/skill?id=${skill.id}" class="w3-btn w3-hover-light-blue w3-round-xlarge">Update</a>
                </td>
                <td>
                    <a href="${pageContext.request.contextPath}/delete/skill?id=${skill.id}" class="w3-btn w3-hover-red w3-round-xlarge">Delete</a>
                </td>
            </tr>
        </c:forEach>
    </table>
