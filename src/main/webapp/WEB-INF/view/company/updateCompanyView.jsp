...
<c:if test="${not empty company}">
    <form method="POST" action="${pageContext.request.contextPath}/company/company/">
        ...
        <nav class="w3-bar-block  w3-light-grey w3-animate-top w3-card w3-round w3-display-bottommiddle">
            <table class="w3-table-all w3-card-4 w3-small w3-margin-top w3-round w3-centered" border="0">
                ...
                <tr>
                    <td><a href="${pageContext.request.contextPath}/all/company/" class="w3-btn w3-hover-red w3-round-xlarge">Cancel</a></td>
                    <td colspan="1">
                        <input type="submit" class="w3-input w3-border w3-hover-green w3-round-xlarge w3-light-blue"
                               value="Submit"><a href="${pageContext.request.contextPath}/all/company/"></a>
                    </td>
                </tr>
            </table>
            <div>
